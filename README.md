...
The `printf` function is a type of function called the variadic function.
A variadic function is a function that takes a variable number of argument.
A general syntax of the variadic function is:
`$  return_type function_name(arg1, arg2, ...);`
Where the ellipsis `(...)` indicate variable number of argument.
